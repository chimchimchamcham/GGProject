...
public class AlarmDAO {
	...
	public ArrayList<GGDto> ALlist(String u_id, String a_impoyn) throws SQLException {
		...
		String sql = "SELECT a_no,u_id,a_code,a_sendtm,a_checktm,a_content,a_readyn,a_delyn,a_impoyn,a_path from ALARM where u_id=? and a_readyn='N' order by a_sendtm desc";
		String sql2 = "SELECT a_no,u_id,a_code,a_sendtm,a_checktm,a_content,a_readyn,a_delyn,a_impoyn,a_path from ALARM where u_id=? and a_impoYN='Y' order by a_sendtm desc";
	...
	public void insertAlarm(String u_id,String a_code,String a_content,String a_impoyn,String a_path) throws SQLException {
		...
		System.out.println("알람전송 갯수 : "+success);
		if(success>0) {
