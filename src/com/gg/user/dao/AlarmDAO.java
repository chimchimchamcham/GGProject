...
public class AlarmDAO {
	...
	public ArrayList<GGDto> ALlist(String u_id, String a_impoyn) throws SQLException {
		...
		String sql2 = "SELECT a_no,u_id,a_code,a_sendtm,a_checktm,a_content,a_readyn,a_delyn,a_impoyn,a_path from ALARM where u_id=? and a_impoYN='Y' order by a_sendtm asc";
