...
#message>#inner{font-size:0.9rem; position:relative;/* background-color:pink; */ top:30px; left:10px}
#message>#last{position:relative;  background-color:green;  top:150px; left:10px}
#last>#check{font-size:1.1rem; /* color:gray; */}
#last>input{top:10px; float:left;  padding-top:2px;}
